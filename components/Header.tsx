      ...
      >
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Booking-Clone.Com</span>
            <img
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
              ...
              <Popover.Panel className="absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {products.map((product) => (
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hoverLbg-gray-200">
                        <product.icon
          ...
          {/* Code these in for functionality */}
